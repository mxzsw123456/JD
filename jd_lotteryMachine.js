...
function updateShareCodes(url = 'https://raw.githubusercontent.com/pukarziu/JinDon/master/NotUpdate/jd_lotteryMachine.js') {
...
function updateShareCodesCDN(url = 'https://raw.githubusercontent.com/pukarziu/JinDon/master/NotUpdate/jd_lotteryMachine.js') {
  return new Promise(resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
